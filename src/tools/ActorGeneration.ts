...
export default async function generateActors(
    ...
    try {
        ...
        const { output } = await generateText({
            ...
            system: "You are a backend procedural generation engine. Generate RPG actors (NPCs, enemies, traders) strictly matching the requested structure.",
                    ...
                    actors: z
                        .array(
                            z.object({
                                ...
                                role: z.enum(["trader", "generic", "enemy", "ally"]).describe("The actor's role in the world"),
