...
const initialState: GameState = {
  ...
  actors: {
    actor_hub_guide: {
      ...
      description:
        "A serene, timeless figure bound to the sanctuary. Facilitates leveling up.",
    ...
    enemy_goblin_thief: {
      ...
      description:
        "A scrawny, green-skinned scavenger wielding a rusted blade.",
      role: "enemy",
      isHostile: true,
      coreMemories: [],
      itemIds: [],
  ...
  rooms: {
    room_sanctuary: {
      ...
      description:
        "A world between worlds where the player can escape to. A quaint small establishment with a garden, a fountain and small house shrouded in mist.",
